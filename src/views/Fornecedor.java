...
public class Fornecedor extends JDialog {
	...
	public Fornecedor() {
		...
		btnPesquisarId.setIcon(new ImageIcon(Fornecedor.class.getResource("/img/search-24.png")));
		...
		btnCreate.setBounds(561, 460, 64, 64);
		...
		btnUpdate.setBounds(656, 460, 64, 64);
		...
		btnDelete.setBounds(738, 460, 64, 64);
	...
	public void adicionar() {
		...
		if (txtCnpj.getText().isEmpty()) {
			...
			try {
				...
				JOptionPane.showMessageDialog(null, "Fornecedor não adicionado - CNPJ existente");
